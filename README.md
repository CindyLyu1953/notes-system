...
- Image OCR and timestamped audio transcription with source-level Evidence
- Deployable S3-compatible artifacts, PostgreSQL job queue, retries, and standalone worker
